    ...
    return ResponsiveLayout(
      ...
      body: _loading
          ...
          : _error != null
              ...
              : _items.isEmpty
                  ? const Center(child: Padding(padding: EdgeInsets.all(48), child: Text('No appointments today.', style: TextStyle(color: AppColors.textSecondary))))
                  : Column(children: _items.map((a) => Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(a.patientName.isEmpty ? 'Patient #${a.patientId ?? ''}' : a.patientName, style: const TextStyle(fontWeight: FontWeight.w700)),
                        subtitle: Text('${Helpers.formatTime(a.appointmentTime)} • ${a.consultationType}'),
